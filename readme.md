...
>
> 完整项目（含 FastAPI + MongoDB + Redis 后端）暂在私有仓库开发中。
...
xTrue 的设计原则——去中心化评价、认同度聚合、分层信任——可以作为电商、内容社区、点评类产品的差异化起点。xTrue 本身不卖排名、不做竞价曝光，如果你认同这个价值观并想落地为商业产品，欢迎取用。

---

## 开发路线图

- [x] 首页 Editorial Flux 多品类布局
- [x] 帖子发布/详情/评论 + 认同度打分
- [x] 分层认证体系（L0-L5）+ httpOnly JWT
- [x] 管理后台（用户/帖子/评论管理、黑名单、认证审核）
- [x] MSW mock 完整覆盖（离线可运行）
- [ ] 投诉与仲裁模块
- [ ] 风控引擎升级（AI 检测 + 行为分析）
- [ ] 移动端适配优化
- [ ] Docker Compose 一键部署
...
xTrue 由一位个人开发者发起。没有团队，没有融资，没有商业计划。如果你觉得这个项目有价值，最好的支持不是捐款，而是**真实地使用它、批评它、改造它**。让一两个真实的声音在这里落地，比任何形式的认可都更有意义。
