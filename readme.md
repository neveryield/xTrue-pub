...
```bash
# 默认启用 MSW mock，无需后端。但及时编译，初次使用界面响应很慢
npm install
...
xTrue 的产品思路是我存在脑子里十几年的想法。而现在借助AI，几天就可以搭建项目基本功能。最终，期待像建立个人信用体系(比如芝麻信用)一样建立任何合法合规产品的信用体系。

“真” 本身就不是“真理”，你认为的真在别人眼里也许就是假。
